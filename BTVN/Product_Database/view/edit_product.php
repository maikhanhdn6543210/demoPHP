        ...
        <div class="col-md-8">
            ...
            <div class="form-group row">
                <div class="col-xs-3">
                    ...
                    <input id="product-price" type="number" step="0.01" name="price" value="<?php echo $product['price']?>" class="form-control" size="60">
                    <span class="error"><?php echo $errPrice;?></span>
                </div>
                <div class="col-xs-3">
                    <label for="product-price-reduce">Price Reduce</label>
                    <input id="product-price-reduce" type="number" name="price_reduce" value="<?php echo $product['price_reduce']?>" class="form-control" size="60">
                </div>
            </div>
            <!-- Product Categories-->
            <div class="form-group">
                ...
                <select name="product_cat_id" id="category-title" class="form-control">
                    <option value="<?php echo $product['product_cat_id'] ?>"><?php echo get_category_name($product['product_cat_id'])  ?></option>
                    <?php get_categories(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <input id="datepicker" type="text" name="date_post" value="<?php echo $product['date_post'] ?>" class="form-control" size="60">                
